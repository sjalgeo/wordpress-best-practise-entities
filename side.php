...
//	$locale = \FreshAmazonClient\Locale\LocaleFactory::getLocale('UK');
	...
	$results = $search->itemSearch('macbook', rand(1, 5) );
...
//		sja_debug($term);
		...
		echo '<h3>'.$term->term_id. '-' .$term->slug.' (' . sizeof($posts_array) . ')</h3>';
...
//	$id = wp_insert_term( 'my product group', 'fresh_product_group' );
